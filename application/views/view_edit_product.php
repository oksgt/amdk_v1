        ...
        <div class="row">
            ...
            <div class="col align-self-center">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" method="post" action="<?= base_url('products/update') ?>">
                        <input type="hidden" name="id" value="<?= $detail['id'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="price" id="price"  value="<?= $formated_price ?>"
                                data-type="currency" placeholder="Product price" required>
                            </div>
                            <div class="form-group">
                                <label for="notes">Notes</label>
                                <textarea class="form-control"  name="notes" id="notes" cols="30" rows="3"><?= trim($detail['notes']) ?></textarea>
                            </div>
                    </div>
